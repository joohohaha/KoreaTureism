					...
					<fieldset class="form-group">
						...
						<div class="form-group">
							<label class="form-control-label">게시글 번호</label> <input
								...
								value="${sboard.bid}" name="bid" readonly>
						</div>
						<div class="form-group">
							<label class="form-control-label">닉네임</label> <input
								class="form-control form-control-lg" type="text"
								value="${sboard.bname}" name="bname" readonly>
						</div>
						<div class="form-group">
							<label class="form-control-label">게시글 제목</label> <input
								class="form-control form-control-lg" type="text"
								value="${sboard.btitle}" name="btitle" readonly>
						</div>

						<div class="form-group">
							<label class="form-control-label"></label>
							<textarea id="textAreaContent" name="bcontent" rows="10"
								cols="80" style="width: 100%" readonly>${sboard.bcontent}</textarea>
						</div>
						<div class="form-group">
							<label class="form-control-label"></label>작성일자<input
								class="form-control form-control-lg" type="text"
								value="${sboard.bdate}" name="bdate" readonly>
						</div>
						<div class="form-group">
							<label class="form-control-label"></label>조회수<input
								class="form-control form-control-lg" type="text"
								value="${sboard.bhit}" name="bhit" readonly>
						</div>
					</fieldset>
				</table>
				<a class="btn btn-outline-warning" href="updateForm?bid=${sboard.bid}">수정</a> 
				<a class="btn btn-outline-danger" href="delete?bid=${sboard.bid}">삭제</a> 
				<a class="btn btn-outline-info" style="float:right" href="board">목록보기</a>
			</div>
		</div>
		<!-- row(12분할) END -->
	</div>
