				...
				<div id="header">
					<h1>
						<a href="index.jsp" class="logo"> <img
							src="resources/memberDesign/images/img_logo_zum_login.png?_LM=1530147020000"
							alt="KOREA" width="222" height="41">
						</a>
					</h1>
				</div>
				<div id="container">
					<div class="login_page">
							...
							<form id="frm_in_login" name="frm_in_login" method="post"
								...
								<fieldset>
									<dl>
										...
										<dd>
											<span class="text_box d_input_area"> <label
												for="password">비밀번호 입력</label> <input type="password"
									...
									<div class="check_ip_security">
										<input type="checkbox" id="btn_ip"> <label
											for="btn_ip" class="checked" id="btn_ip_on"> <!-- checked : IP 보안 ON 상태 -->
                        ...
                        -->
									...
									<div class="btn_login">
										...
										<input id="loginTargetUrl" name="targetUrl" type="hidden"
											value="#">
									</div>
								</fieldset>
							</form>
						...
						<div class="login_menu">
							<ul>
								<li><a id="btn_find_id" href="#">아이디 찾기</a></li>
								<li><a id="btn_find_pass" href="#">비밀번호 찾기</a></li>
								<li><a id="btn_join" href="#">회원가입</a></li>
							</ul>
						</div>
					</div>
				</div>
